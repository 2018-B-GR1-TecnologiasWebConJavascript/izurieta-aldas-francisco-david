...
const respuestaFindIndex = arregloNumeros.findIndex(v => v === 7);
...
const respuestaFind = arregloNumeros.find(v => v === 7);

console.log(respuestaFind);

// some - boolean

const respuestaSome = arregloNumeros.some(n => n % 11 === 0);
...
const respuestaReduceV3 = arregloNumeros.reduce((acumulado, valorActual) => {
  if (valorActual > 7) {
